...
public class Game : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            case "M":
                _player = (GameObject)Instantiate(maleCharactorPrefab, Vector3.zero, Quaternion.identity, map.transform);
                break;
            case "F":
                _player = (GameObject)Instantiate(femaleCharactorPrefab, Vector3.zero, Quaternion.identity, map.transform);
                break;
            default:
                _player = (GameObject)Instantiate(defaultCharactorPrefab, Vector3.zero, Quaternion.identity, map.transform);
                break;
        }
        _player.name = "Player";
    ...
    public void MovePlayerToCell(int cellPosition)
    {
        ...
        _player.transform.localPosition = curtCellPosition;
        _player.transform.LookAt(_player.transform.position + deltaVector);
        PlayerPrefs.SetInt("Position", cellPosition);
        _camera.transform.localPosition = new Vector3(
            _player.transform.localPosition.x - (deltaVector.z + deltaVector.x)*0.1f,
            _player.transform.localPosition.y + 6f,
            _player.transform.localPosition.z - (deltaVector.z - deltaVector.x)*0.1f
        );
